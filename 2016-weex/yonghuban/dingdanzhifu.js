...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/0566b74d058ca2baba53aee2aceb326c", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                判断跳转洗车还是修车的评价    订单类型 1代驾单 修车单 2拖车单 3救援单 4洗车单5送车单
	                ...
	                if (this.zhifufangshi == 1 && this.panduan == 1) {   //微信
	                    api.call("wxpay/order", {orderId: _this.ddid, redId: _this.hbid}, function (ret) {
	                        api.log(ret.data);
	                        __weex_require__('@weex-module/wxpay').wxpay(ret.data.payInfo, function (e) {
	                            api.log(e.result);
	                            if (e.result == "成功") {
	                    ...
	                    api.call("alipay/order", {orderId: _this.ddid, redId: _this.hbid}, function (ret) {
	                        __weex_require__('@weex-module/alipay').alipay(ret.data.payInfo, function (e) {
	                            api.log(e.result);
	                            if (e.result == "成功") {
	                                api.call("factory/addRepairRecord", {
	                                    orderId: _this.ddid,
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "shown": function () {return this.redbao!=0},
	                  "attr": {
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "src": function () {return (this.dir) + 'images/yinlian.jpg'}
	                      }
	                    },
	                    {
	                      "type": "text",
	...
	;__weex_bootstrap__("@weex-component/0566b74d058ca2baba53aee2aceb326c", {
