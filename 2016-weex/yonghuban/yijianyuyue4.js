...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/7db6bcdc44036dad30039f2299d9c83f", [], function(__weex_require__, __weex_exports__, __weex_module__){
	                ...
	                if (this.isfuwu == 0) {
	                    if (isNaN(this.gongli) || this.gongli == "" || this.gongli <= 0) {
	                        ...
	                        api.get("orderinfo", function (e) {
	                            ...
	                            orderinfo.mileage = _this.gongli;
	...
	//                        api.push("xichemeirong3.js", {xuanze: true, cheid: this.cheid});
	                        api.push("xiangmuqueren.js",{fanhuiurl:"yijianyuyue4.js"})
	                    }
	                } else {
	                    api.tost("此车正在服务中.....");
	                }
	...
	//                        api.log("id:" + ret.data.myCarInfo[ind].id);
	                    ...
	                    _this.tu = ret.data.myCarInfo[0].carIcon;
	                    _this.cp = ret.data.myCarInfo[0].carLicence;
	                    _this.cx = ret.data.myCarInfo[0].carFullTypeName;
	                    _this.rq = ret.data.myCarInfo[0].carGotTime.slice(0, 10);
	                    _this.isfuwu = ret.data.myCarInfo[0].inServiceOrderId;
	                }
	                for (var i = 0; i < 4; i++) {
	...
	;__weex_bootstrap__("@weex-component/7db6bcdc44036dad30039f2299d9c83f", {
