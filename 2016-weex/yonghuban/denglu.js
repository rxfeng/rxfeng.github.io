...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/6ed4a4e778603ebc5ed3bba6480419df", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                    api.log("真实姓名："+ret.data.userInfo.realName)
	                    api.save("userinfo", {
	                        userSex: ret.data.userInfo.userSex,
	                    ...
	                    api.bing("YX_"+ret.data.userInfo.id, function (e) {
	                        api.log(e);
	                    });
	                });
	            },
	...
	//                    var data = {cellphone: this.tel}
	                    api.call("user/sendSMS", {cellphone: this.tel}, function (ret) {
	                    });
	//                 -----------------------获取验证码-----------------------------------
	                } else {
	            ...
	            qqclick: function (e) {
	                __weex_require__('@weex-module/login3').login3("qq", function (e) {
	                    var api = __webpack_require__(14);
	                    api.log(e);
	//            -----------------------第三方登录（qq）-----------------------------------
	                    var info = {
	...
	//            -----------------------第三方登录（qq）-----------------------------------
	            ...
	            weixinclick: function (e) {
	                __weex_require__('@weex-module/login3').login3("weixin", function (e) {
	                    var api = __webpack_require__(14);
	                    api.log(e);
	//            -----------------------第三方登录（qq）-----------------------------------
	                    var info = {
	...
	//            -----------------------第三方登录（qq）-----------------------------------
	            ...
	            weiboclick: function (e) {
	                __weex_require__('@weex-module/login3').login3("sina", function (e) {
	                    var api = __webpack_require__(14);
	                    api.log(e);
	//            -----------------------第三方登录（qq）-----------------------------------
	                    var info = {
	...
	;Object.assign(__weex_module__.exports.template, {
	  ...
	  "children": [
	    {
	      "type": "div",
	      "classList": function () {return [this.pos]},
	      "children": [
	        {
	          "type": "div",
	          "style": {
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "type": "tel",
	                "placeholder": "验证码",
	                "value": function () {return this.yanzheng}
	              },
	              "events": {
	                "input": "oninput2"
	              }
	            ...
	            {
	              "type": "text",
	              "shown": function () {return this.yzm},
	              "classList": [
	                "yanzhengma"
	              ],
	              "events": {
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return (this.date.s) + '秒后重试'}
	              }
	            }
	          ]
	        },
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "src": function () {return (this.dir) + 'images/weixin1.png'}
	          }
	        },
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": function () {return (this.dir) + 'images/weibo2.png'}
	          }
	        },
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": function () {return (this.dir) + 'images/qq3.png'}
	          }
	        }
	      ]
	    }
	...
	;__weex_bootstrap__("@weex-component/6ed4a4e778603ebc5ed3bba6480419df", {
...
/***/ function(module, exports) {
	...
	;__weex_define__("@weex-component/zi-login-btn", [], function(__weex_require__, __weex_exports__, __weex_module__){
