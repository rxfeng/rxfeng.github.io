...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/94f77c7bdfadcd3c27018968db9504b0", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                api.log(_this.date.hh+" "+_this.date.mm+" "+_this.date.ss);
	                    ...
	                    __weex_require__('@weex-module/geolocation').getCurrentPosition({}, function (e) {    //定位当前位置
	                        var lnglat = {};
	...
	;Object.assign(__weex_module__.exports.template, {
	  ...
	  "children": [
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return (this.date.yueri) + ' ' + (this.date.xingqi) + ' 今日在线' + (this.date.hh) + ':' + (this.date.mm) + ':' + (this.date.ss)}
	          }
	        }
	      ]
	    },
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.danshu}
	              }
	            },
	            {
	              "type": "text",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.shouru}
	              }
	            },
	            {
	              "type": "text",
	    ...
	    {
	      "type": "div",
	      "shown": function () {return this.xinxiflag},
	      "style": {
	        "position": "relative"
	      },
	      "children": [
	        ...
	        },
	        {
	          "type": "jiedan",
	          "attr": {
	            "txt": function () {return this.jiedanTitle}
	          },
	          "classList": [
	            "btn2"
	          ],
	    ...
	    },
	    {
	      ...
	      "children": [
	        {
	          "type": "btn",
	          "shown": function () {return this.kstd},
	          "attr": {
	            "title": "开始听单"
	          },
	          "classList": [
	...
	;__weex_bootstrap__("@weex-component/94f77c7bdfadcd3c27018968db9504b0", {
