...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/f23136632a0e5e482f48c5d420788ac0", [], function(__weex_require__, __weex_exports__, __weex_module__){
	        ...
	        methods:{
	            ani: function (e) {
	                ...
	                __weex_require__('@weex-module/geolocation').getCurrentPosition({}, function (e) {
	                    _this.markers = [{ position: [_this.lat, _this.lon]},{position:[e.latitude, e.longitude]}];  //                    前面是对方,后面是本人
	            ...
	            huadongclick: function (e) {
	                ...
	                if(e.str=="确定"){
	                    api.call("driver/tuoche",{orderId:_this.orderId}, function (ret) {
	                        clearInterval(timer);
	                        api.push("tuoche.js", {orderId: _this.orderId,end:_this.mdd}, function (e) {
	                            api.refresh();
	                        });
	                    })
	                }
	...
	;__weex_bootstrap__("@weex-component/f23136632a0e5e482f48c5d420788ac0", {
...
/***/ function(module, exports) {
	...
	//        var SERVER_URL = "http://www.yixiucar.com/app/fac/";      //郭总
	    //    var SERVER_URL = "http://www.yixiucar.com/app/d2irver/";      //郭总
	...
	//    exports.selectTime = function (parm,callback) {
	//        __weex_require__('@weex-module/dialog').selectTime(parm,callback);
	//    }
	//    exports.selectDate = function (parm,callback) {
	//        __weex_require__('@weex-module/dialog').selectDate(parm,callback);
	//    }
	//    exports.selectDateTime = function (parm,callback) {
	//        __weex_require__('@weex-module/dialog').selectDateTime(parm,callback);
	//    }
