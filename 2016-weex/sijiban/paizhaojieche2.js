...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/4f1f73541fc401947e008eac8ecc3a29", [], function(__weex_require__, __weex_exports__, __weex_module__){
	    ...
	    __weex_module__.exports = {
	        ...
	        methods: {
	            ...
	            aa1: function (e) {
	                ...
	                __weex_require__('@weex-module/picture').camera({}, function (e) {
	                    list[index]= e.path;
	//                    list.push(e.path);
	                    _this.img = e.path;
	                });
	            ...
	            querenclick: function (e) {
	                ...
	                if (_this.imgs[0].img != img1
	                    ...
	                    __weex_require__('@weex-module/picture').postFile(list, function (e) {
	                        api.call("photo/driverPhoto", {
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "div",
	                  "repeat": function () {return this.imgs},
	                  "id": "images",
	                  "children": [
	                    {
	                      "type": "image",
	...
	;__weex_bootstrap__("@weex-component/4f1f73541fc401947e008eac8ecc3a29", {
