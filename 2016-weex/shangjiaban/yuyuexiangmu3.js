...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/8ddcd09caeceac13c343413a1f06ca64", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;
	    ...
	    __weex_module__.exports = {
	        ...
	        ready: function () {
	            ...
	            api.log(id);
	            //            -----------------------预约项目-----------------------------------
	            api.call("factory/adviserOrderItem", {
	                id: id
	            }, function (ret) {
	                _this.clxh = ret.data.carType;
	                _this.cphm = ret.data.carLicence;
	                if(ret.data.suggestInfo.length==0){
	                    _this.fff = true;
	                }else if(ret.data.suggestInfo.length>=1){
	                    _this.fff = false;
	                }
	                for (var i = 0; i < ret.data.suggestInfo.length; i++) {
	                    _this.yyxm.$set(i, {
	                        jiyou: ret.data.suggestInfo[i].programName,
	                        bargain: ret.data.suggestInfo[i].bargain,
	                        cost: ret.data.suggestInfo[i].cost,
	                    })
	                }
	            });
	            //            -----------------------预约项目-----------------------------------
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.clxh}
	                  }
	                }
	              ]
	            },
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            {
	              "type": "div",
	              "repeat": function () {return this.yyxm},
	              "children": [
	                {
	                  "type": "div",
	                  "classList": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "children": [
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.jiyou}
	                          }
	                        }
	                      ]
	                    },
	...
	;__weex_bootstrap__("@weex-component/8ddcd09caeceac13c343413a1f06ca64", {
