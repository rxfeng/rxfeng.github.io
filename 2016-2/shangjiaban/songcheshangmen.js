...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/a5e9af98053c543e4cef48d71634926d", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                    api.log(JSON.parse(e.position)[0].position[0]+","+JSON.parse(e.position)[0].position[1]);
	            ...
	            riqiclick: function (e) {
	                var _this = this;
	                __weex_require__('@weex-module/datetime').selectDate("",function(e){
	            ...
	            shijianclick: function (e) {
	                var _this = this;
	                __weex_require__('@weex-module/datetime').selectTime("",function(e){
	//                    api.log(e.h);
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.locval}
	                  }
	                },
	                {
	                  "type": "image",
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return this.riqi}
	              }
	            },
	            {
	              "type": "text",
	...
	;__weex_bootstrap__("@weex-component/a5e9af98053c543e4cef48d71634926d", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/zi-dd", [], function(__weex_require__, __weex_exports__, __weex_module__){
