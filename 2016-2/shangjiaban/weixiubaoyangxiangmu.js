...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/fd71724dc0bee6612341ac5552d5cd34", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;
	    ...
	    __weex_module__.exports = {
	        ...
	        created: function () {
	            ...
	            api.log("ddid:"+ddid);
	//            -----------------------维修保养记录-----------------------------------
	            api.call("factory/queryRepair", {id:ddid}, function (ret) {
	                if(ret.data.rreInfo.oiList.length==0){
	                    _this.fff = true;
	                }else if(ret.data.rreInfo.oiList.length>=1){
	                    _this.fff = false;
	                }
	                _this.oiList = ret.data.rreInfo.oiList;
	            });
	        },
	        methods:{
	            zhuyiclick: function (e) {
	                var _this = this;
	                api.call("factory/queryOiMess", {id: _this.id}, function (ret) {
	                    api.log(ret.data)
	                    api.dialog(_this.dir + "zi-tishi.js",{zhuyitxt:ret.data.mpInfo.describeMess});
	//                    _this.zhuyitxt = ret.data.mpInfo.describeMess;
	//                    __weex_require__('@weex-module/modal').alert({
	//                        'message': _this.zhuyitxt,
	//                        'okTitle': "确定",
	//                    });
	                });
	            }
	...
	;Object.assign(__weex_module__.exports.template, {
	  ...
	  "attr": {
	    "navtitle": "维修保养项目",
	    "navrighttitle": function () {return this.title},
	    "navrighturl": "",
	    "navrightsrc": "",
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            {
	              "type": "div",
	              "repeat": function () {return this.oiList},
	              "children": [
	                {
	                  "type": "div",
	                  "classList": [
	...
	;__weex_bootstrap__("@weex-component/fd71724dc0bee6612341ac5552d5cd34", {
