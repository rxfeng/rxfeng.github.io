...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/62614cd8c70fafc78f98f507971cf197", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                __weex_require__('@weex-module/tochatuser').setData(e.data, "YX_" + userid, "123456", "YX_" + _this.zhuanjiaid, ret.data.inserEntity.issueId);
	//                api.get("userinfo", function (h) {
	//                    userid = JSON.parse(h.data).userid;
	//                })
	//                api.get("token", function (e) {
	//                    __weex_require__('@weex-module/tochatuser').setData(e.data, "YX_" + userid, "123456","YX_8080");
	//                })
	                api.tost("sorry，暂无此功能")
	                api.hidden();
	            },
	            wanchengclick2: function (e) {
	                __weex_require__('@weex-module/dialanumber').boHao("4006-655-679");
	                api.hidden();
	            },
	...
	;__weex_bootstrap__("@weex-component/62614cd8c70fafc78f98f507971cf197", {
