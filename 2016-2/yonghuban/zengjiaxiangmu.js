...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/dfa6b9638c2dee162f5e36dca33c8fad", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                _this.jiuredqian = ret.data.adviserCost;
	                _this.jiuhuiqian = ret.data.sumcost;
	                _this.jiuyhjia = ret.data.sumcost - ret.data.cost;
	                for(var i = 0; i<ret.data.suggestInfo.length;i++){
	                    if(ret.data.suggestInfo[i].isChecked){
	                        ...
	                        item[i] = ret.data.suggestInfo[i];
	                    }
	                }
	                _this.huiqian = _this.huiqian + ret.data.sumcost ;
	                _this.chajia = _this.chajia +_this.jiuyhjia;
	                for(var j = 0;j<item.length;j++){
	                    _this.chajia1 = (item[j].cost - item[j].bargain) + _this.chajia1;
	                }
	            });
	        },
	        methods:{
	            ...
	            danxuanclick: function (e) {
	                ...
	                for(var i = 0; i<_this.list2.length;i++){
	                    if(_this.list2[i].isChecked){
	                        ...
	                        item[a++] = _this.list2[i];
	                    }
	                }
	                _this.huiqian = _this.huiqian + _this.jiuhuiqian ;
	                _this.chajia = _this.chajia  + _this.jiuyhjia;
	                _this.chajia1 = 0;
	                for(var j = 0;j<item.length;j++){
	                    _this.chajia1 = (item[j].cost - item[j].bargain) + _this.chajia1;
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return '￥' + (this.info.cost)}
	              }
	            }
	          ]
	        },
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return (this.programName) + ' ' + (this.programParts)}
	                          }
	                        },
	                        {
	                          "type": "image",
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return '￥' + (this.jianyiqian)}
	              }
	            }
	          ]
	        },
	        ...
	        },
	        {
	          ...
	          "children": [
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "value": function () {return '－￥' + (this.chajia1)}
	              }
	            }
	          ]
	        },
	...
	;__weex_bootstrap__("@weex-component/dfa6b9638c2dee162f5e36dca33c8fad", {
