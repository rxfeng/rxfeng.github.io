...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/e3ddf72ed787303ff5d89783df795151", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                var info = {keyword: _this.val, type: _this.txt1, area: _this.txt2, sort: _this.rank}
	                var info = {keyword: _this.val,type:9, carId:_this.cheid,area: _this.txt2, sort: _this.rank}
	                api.call("factory/list", info, function (ret) {
	                    if(ret.data.datas==""){
	                        _this.fh = true;
	                    }else{
	...
	//                api.log(e.target.children[0].attr.value);
	                ...
	                var _this = this;
	                _this.serverData=[];
	                var info = {keyword: _this.val, type: _this.txt1, area: _this.txt2, sort: _this.rank, carId:_this.cheid,}
	                api.call("factory/list", info, function (ret) {
	                    if(ret.data.datas==""){
	                        _this.fh = true;
	                    }else{
	...
	//            -------------------------------商家列表---------------------------------
	        ...
	        created: function () {
	            var _this = this;
	            _this.cheid = api.getData(_this).cheid;
	//            -------------------------------城区信息---------------------------------
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "src": function () {return (this.dir) + 'images/sousuo1.png'}
	      },
	      "events": {
	        "click": "sousuoclicktop"
	      }
	    },
	    {
	      "type": "text",
	    ...
	    },
	    {
	      ...
	      "shown": function () {return this.sousuo},
	      "children": [
	        {
	          "type": "div",
	          "classList": [
	      ...
	      "children": [
	        {
	          ...
	          "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return (this.dir) + 'images/sousuo3.png'}
	                  }
	                }
	              ]
	            },
	            ...
	            },
	            {
	              ...
	              "attr": {
	                "src": function () {return (this.dir) + 'images/cha.png'}
	              }
	            }
	          ]
	        },
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    ...
	                    "dingdanhao": function () {return this.dingdanhao},
	                    "txt1": function () {return this.txt1}
	                  }
	                },
	                {
	                  "type": "div",
	...
	;__weex_bootstrap__("@weex-component/e3ddf72ed787303ff5d89783df795151", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/sy-neirong3", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;Object.assign(__weex_module__.exports.template, {
	  ...
	  "children": [
	    {
	      "type": "div",
	      "shown": function () {return this.falg},
	      "classList": [
	        "cont"
	      ],
	      "events": {
