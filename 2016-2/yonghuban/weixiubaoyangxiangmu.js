...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/fe22df47c1ae4d051e5e6e3d65f61311", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;
	    ...
	    __weex_module__.exports = {
	        ...
	        ready: function () {
	            ...
	            api.log("ddid:"+ddid);
	//            -----------------------维修保养记录-----------------------------------
	            api.call("car/queryRrItem", {id:ddid}, function (ret) {
	                api.log(ret.data);
	                ...
	                if(ret.data.oiList.length==0){
	                    _this.fff = true;
	                }else if(ret.data.oiList.length>=1){
	                    _this.fff = false;
	                }
	            });
	//            -----------------------维修保养记录-----------------------------------
	            _this.$on('naviBar.rightItem.click',function(e){
	                if(_this.type==1){
	                    api.call("car/delRepairRecord", {id:ddid}, function (ret) {
	                        api.log(ret.data);
	                        api.pop({ddid:ddid});
	                    });
	                }
	...
	;__weex_bootstrap__("@weex-component/fe22df47c1ae4d051e5e6e3d65f61311", {
