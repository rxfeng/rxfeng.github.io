...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/c08887fa5a695d0f6086631794ffb296", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	;
	    ...
	    __weex_module__.exports = {
	        ...
	        ready: function () {
	            ...
	            api.log("ddid:"+ddid);
	//            -----------------------维修保养记录-----------------------------------
	            api.call("factory/userOrderItem", {orderId:ddid}, function (ret) {
	                api.log(ret.data);
	                _this.oiList = ret.data.oiInfo;
	...
	;__weex_bootstrap__("@weex-component/c08887fa5a695d0f6086631794ffb296", {
