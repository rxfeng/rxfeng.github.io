...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/2b72b2925475b1fd78c96d47701370a4", [], function(__weex_require__, __weex_exports__, __weex_module__){
	...
	//                api.log(this.zhuanjia.onceIntegral);
	                var _this = this;
	//                api.call("factory/MyConsultParticulars", {expertId: _this.zjid,issueId:_this.issueId}, function (ret) {
	//                    api.log(ret.data);
	//                });
	                api.call("factory/getExpertType", {}, function (ret) {
	                    ...
	                    __weex_require__('@weex-module/fabuchenggong').fabu("", function (e) {
	                        api.log(e);
	                        if(e.neirong=="" || e.xitong==""){
	                            api.tost("请添加系统和问题内容")
	                        }else{
	                            api.call("factory/postQuestion", {issueTitle:e.neirong,issueTypeName:e.xitong,issueId:_this.issueId}, function (ret) {
	                                __weex_require__('@weex-module/finish').finLis();
	                            });
	                        }
	                    },item);
	                });
	        ...
	        created: function () {
	            ...
	            api.call("factory/MyConsultParticulars", {expertId: _this.zjid,issueId:_this.issueId}, function (ret) {
	                _this.zhuanjia = ret.data.myConEntity.expert;
	                _this.list = ret.data.myConEntity.issueLogs;
	                _this.issueState = ret.data.myConEntity.issueState;
	                api.log(ret.data.myConEntity.issueState)
	            });
	        }
	    }
	...
	;Object.assign(__weex_module__.exports.template, {
	  ...
	  "attr": {
	    "navtitle": "问题详情",
	    "navrighttitle": "",
	    "navlefturl": "zhuanjiawenzhang.js",
	    "navrightsrc": "",
	    "navrighturl": "",
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	            ...
	            },
	            {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return '年限：' + (this.zhuanjia.years) + '年'}
	                  }
	                },
	                {
	                  "type": "text",
	        ...
	        },
	        {
	          ...
	          "shown": function () {return !this.issueState},
	          "children": [
	            {
	              "type": "text",
	              "classList": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "shown": function () {return this.logType==0},
	                      "children": [
	                        {
	                          "type": "text",
	                          "classList": [
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.logContent}
	                          }
	                        },
	                        {
	                          "type": "div",
	                    ...
	                    },
	                    {
	                      ...
	                      "shown": function () {return this.logType==1},
	                      "children": [
	                        {
	                          "type": "text",
	                          "classList": [
	...
	;__weex_bootstrap__("@weex-component/2b72b2925475b1fd78c96d47701370a4", {
