...
/***/ function(module, exports, __webpack_require__) {
	...
	;__weex_define__("@weex-component/824b73ca565d10dc2e7e226b85e51d4c", [], function(__weex_require__, __weex_exports__, __weex_module__){
	    ...
	    __weex_module__.exports = {
	        ...
	        created: function () {
	            ...
	            __weex_require__('@weex-module/geolocation').getCurrentPosition({}, function (e) {
	                _this.position = [e.latitude, e.longitude];  //                    ǰ���ǶԷ�,�����Ǳ���
	            });
	        ...
	        methods:{
	            telclick: function (e) {
	                __weex_require__('@weex-module/utils').callPhone(this.driverInfo.cellphone);
	            },
	        }
	    }
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "repeat": function () {return this.driverInfo},
	              "children": [
	                {
	                  "type": "image",
	                  "classList": [
	                ...
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return '���ݣ�' + (this.designatedCount||0) + ' ���䣺' + (this.experienceYear||0)}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return '�绰��' + (this.cellphone||'')}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return '����֤��' + (this.numID||'')}
	                      }
	                    }
	                  ]
	                }
	        ...
	        },
	        {
	          ...
	          "attr": {
	            "value": function () {return '������' + (this.distance) + '�����Լ��Ҫ' + (this.minute) + '����'}
	          }
	        },
	        {
	          "type": "div",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                ...
	                "uiconfig": "{location:true,zoom:true,center:false}",
	...
	;__weex_bootstrap__("@weex-component/824b73ca565d10dc2e7e226b85e51d4c", {
